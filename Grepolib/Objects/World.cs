...
namespace Grepolib.Objects
{
    public class World
    {
        ...
        private string BaseURL
        {
            get
            {
                return String.Format("https://{0}{1}.grepolis.com/data/", Region.ToString().ToLower(), WorldID);
            }
        }
        ...
        public List<Player> Players
        {
            get
            {
                ...
                using (HttpClient httpClient = new HttpClient())
                {
                    ...
                    var stream = httpClient.GetStreamAsync(BaseURL + "players.txt").Result;
        ...
        public List<Alliance> Alliances
        {
            get
            {
                ...
                {
                    httpClient.Timeout = TimeSpan.FromMilliseconds(Timeout.Infinite);
                    var stream = httpClient.GetStreamAsync(BaseURL + "alliances.txt").Result;
        ...
        public List<Town> Towns
        {
            get
            {
                ...
                {
                    httpClient.Timeout = TimeSpan.FromMilliseconds(Timeout.Infinite);
                    var stream = httpClient.GetStreamAsync(BaseURL + "towns.txt").Result;
        ...
        public List<Island> Islands
        {
            get
            {
                ...
                {
                    httpClient.Timeout = TimeSpan.FromMilliseconds(Timeout.Infinite);
                    var stream = httpClient.GetStreamAsync(BaseURL + "islands.txt").Result;
        ...
        private Resource ParseResource(string resourceString)
        {
